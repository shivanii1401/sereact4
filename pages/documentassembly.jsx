...
import "./documentassembly.css";
import rafiki from "../ComponentsESign/images/rafikidaimage1.svg";
import rafikioffice from "../ComponentsESign/images/rafikioffice.svg";
...
import VectorfolderDA from "../ComponentsESign/images/VectorfolderDA.svg";
import pdf from "../ComponentsESign/images/pdf.svg";
import group217 from "../ComponentsESign/images/Group 217folder.svg";
import rafikionlinedoc from "../ComponentsESign/images/rafikionlinedoc.svg";
import decDA from "../ComponentsESign/images/Group 223docDA.svg";
import groupcradDA from "../ComponentsESign/images/GroupcardDA.svg";
import starDA from "../ComponentsESign/images/VectorstarDA.svg";
...
class  Documentassembly extends React.Component{
    render(){
        return(
      <div>
        <section>
          <div className="container">
            <div className="row no-margin g-0 exp bookacalltop full-bleed">
              <div className="col">
                <h1 className="headingbookacall">Document Assembly</h1>
              </div>
              <div className="col">
                <img className="bookacallimage1 img-fluid" src={rafiki} />
              </div>
            </div>
          </div>
        </section>
        <section>
          <div className="container">
            <div className="row">
              <h5 className="DAh5"><b>Document Assembly</b></h5>
              <h1 className="DAheading">A Powerful And Flexible Way To<span className="text-primary"> Digitally Transform<br /> Your Agreement Kits</span> </h1>
              <p className="DAheadingp">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore<br /> magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut<br /> 
                aliquip ex ea commodo consequat.</p>
            </div>
            <div className="row">
              <div className="col DAbox3">
                <div className="DAicon">
                  <img src={pdf} className="pdfbg" width="38px" height="38px" />
                </div>
                <p className="DAboxp">Upload A PDF of Your Agreement Kits</p>
              </div>
              <div className="col DAbox3">
                <div className="DAicon">
                  <img src={group217} className="pdfbg" />
                </div>
                <p className="DAboxp">Use Ready-to-execute Templates</p>
              </div>
              <div className="col DAbox3">
                <div className="DAicon">
                  <img src={pdf} className="pdfbg" />
                </div>
                <p className="DAboxp">Upload And Combine Multiple PDFs</p>
              </div>
            </div>
          </div>
        </section>
        <section className="DAsec3">
          <div className="container">
            <div className="row">
              <div className="col-8">
                <h1 className="DAheadingsec3">Avoid manual errors and save<br /> time with<span className="text-primary"> Template Engine</span> </h1>
                <p className="DAheadingpsec3">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor<br /> incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud<br /> exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat.</p>
                <p className="DAheadingpsec3">Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat<br /> nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui<br /> officia deserunt mollit anim id est laborum.</p>
                <button className="readmore mt-4">Read more <svg xmlns="http://www.w3.org/2000/svg" width={13} height={12} viewBox="0 0 13 12" fill="none">
        ...
        <section className>
          <div className="container">
            <div className="row">
              <div className="col-4 mt-5 pt-4">
                <img src={rafikionlinedoc} />
              </div>
              <div className="col-8 ps-lg-5">
                <h1 className="DAheadingsec3">Combine your PDFs into a single document<br /> with <span className="text-primary"> Multi-PDF </span>upload </h1>
                <p className="DAheadingpsec3">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor<br /> incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud<br /> exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat.</p>
                <p className="DAheadingpsec3">Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat<br /> nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui<br /> officia deserunt mollit anim id est laborum.</p>
                <button className="readmore mt-4 mb-lg-5">Read more <svg xmlns="http://www.w3.org/2000/svg" width={13} height={12} viewBox="0 0 13 12" fill="none">
                    <path d="M7.65918 10.1668L11.7971 6.00016L7.65918 1.8335" stroke="white" strokeWidth={2} strokeLinecap="round" strokeLinejoin="round" />
                    <path d="M7.65918 10.1668L11.7971 6.00016L7.65918 1.8335" stroke="#2828C2" strokeWidth={2} strokeLinecap="round" strokeLinejoin="round" />
                    <path d="M1.86621 10.1668L6.00409 6.00016L1.86621 1.8335" stroke="white" strokeWidth={2} strokeLinecap="round" strokeLinejoin="round" />
                    <path d="M1.86621 10.1668L6.00409 6.00016L1.86621 1.8335" stroke="#2828C2" strokeWidth={2} strokeLinecap="round" strokeLinejoin="round" />
            ...
            <div className="row">
              <div className="col-6 DAsec4box">
                <h3>Create Multiple Documents In One-go With<br /> Excel Upload</h3>
                <p className="mt-3">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do<br /> eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut<br /> enim ad minim veniam, quis nostrud exercitation ullamco laboris<br /> nisi ut aliquip ex ea commodo consequat.</p>
                <p>Duis aute irure dolor in reprehenderit in voluptate velit esse cillum<br /> dolore eu fugiat nulla pariatur.</p>
                <button className>Learn More About Excel Upload  <svg xmlns="http://www.w3.org/2000/svg" width={13} height={12} viewBox="0 0 13 12" fill="none">
                    <path d="M7.65918 10.1668L11.7971 6.00016L7.65918 1.8335" stroke="white" strokeWidth={2} strokeLinecap="round" strokeLinejoin="round" />
                    <path d="M7.65918 10.1668L11.7971 6.00016L7.65918 1.8335" stroke="#2828C2" strokeWidth={2} strokeLinecap="round" strokeLinejoin="round" />
                    <path d="M1.86621 10.1668L6.00409 6.00016L1.86621 1.8335" stroke="white" strokeWidth={2} strokeLinecap="round" strokeLinejoin="round" />
                    <path d="M1.86621 10.1668L6.00409 6.00016L1.86621 1.8335" stroke="#2828C2" strokeWidth={2} strokeLinecap="round" strokeLinejoin="round" />
              ...
              <div className="col-6 DAsec4box">
                <h3>Auto-populate Templates With Apis <br />
                  Within Seconds</h3>
                <p className="mt-3">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do<br /> eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut<br /> enim ad minim veniam, quis nostrud exercitation ullamco laboris<br /> nisi ut aliquip ex ea commodo consequat.</p>
                <p>Duis aute irure dolor in reprehenderit in voluptate velit esse cillum<br /> dolore eu fugiat nulla pariatur.</p>
                <button className>Learn More About Excel Upload  <svg xmlns="http://www.w3.org/2000/svg" width={13} height={12} viewBox="0 0 13 12" fill="none">
        ...
        <section className="DAlast">
          <div className=" container">
            <div className="row">
              <h2>eSign Document Assembly is flexible and powerful - built for<br /> the real world use cases of Indian companies</h2>
            </div>
            <div className="row">
              <div className="col-3 DAlastbox text-center">
                <div className="DAiconlast">
                  <img src={VectorfolderDA} width="29px" height="36px" />
                </div>
                <p className="DAlastboxp">Attach Supporting <br />
                  Documents In Your Docket</p>
              </div>
              <div className="col-3 DAlastbox text-center ">
                <div className="DAiconlast">
                  <img src={groupcradDA} width="28px" height="35px" />
                </div>
                <p className="DAlastboxp">Supports File Sizes<br /> 
                  Upto 15mb - For Your Heavy <br />
                  Duty  Document Kits</p>
              </div>
              <div className="col-3 DAlastbox text-center">
                <div className="DAiconlast">
                  <img src={starDA} width="28px" height="35px" />
                </div>
                <p className="DAlastboxp">eSign Template Team Will <br />
                  Help You Build Your Templates <br />
                  Very Quickly</p>
              </div>
              <div className="col-3 DAlastbox text-center">
                <div className="DAiconlast">
                  <img src={decDA} width="28px" height="35px" />
                </div>
                <p className="DAlastboxp">Create Documents From <br />
                  Day 1 With Dashboard - No <br />
                  Need For Tech Teams</p>
              </div>
            </div>
          </div>
        </section>   
...
export default Documentassembly;